...
export default {
  ...
  ru: {
    ...
    home: {
      ...
      Она предоставляет гораздо больше информации об объекте, чем это может NER. В тоже время, для ее работы не требуется наличие какой-либо базы знаний.
      ...
      feature_one: `Нейросеть способна рассматривать до пяти упоминаний одновременно, что позволяет учитывать все факторы более эффективно, чем этого можно было бы достичь усреднением отдельных предсказаний`,
